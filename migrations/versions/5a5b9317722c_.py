...
Revision ID: 5a5b9317722c
Revises: 8dda1c64e95e
Create Date: 2019-09-27 10:42:43.778122
...
revision = '5a5b9317722c'
down_revision = '8dda1c64e95e'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['post_id'], ['post.id'], name='user_post_ibfk_1'),
    sa.ForeignKeyConstraint(['user_id'], ['cm_user.id'], name='user_post_ibfk_2'),
    sa.PrimaryKeyConstraint('user_id', 'post_id'),
