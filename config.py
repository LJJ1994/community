...
class Config(object):
    ...
    SECRET_KEY = 'iBxcNMBxDN5uSjqlKffRX3HDabfSuTHyhzKvoK3GgIjSyweGqfDzIStNqb1v/Xvm'

    # 数据库的配置信息
    SQLALCHEMY_DATABASE_URI = "mysql://root:Ljj940617@127.0.0.1:3306/community"
...
class ProductionConfig(Config):
    DEBUG = False
    SQLALCHEMY_DATABASE_URI = "mysql://root:test@127.0.0.1:3306/community"
